...
public class BmiQueries {
    ...
    private static String bmiRange = "SELECT *FROM STATS WHERE (weight/((height/100)*2))>=" + BMIView.minBMI
            + " AND (weight/((height/100)*2))<=" + BMIView.maxBMI;
    ...
    public static String getBMIRange(Double minBMI, double maxBMI) {
        return ("SELECT *FROM STATS WHERE (weight/((height/100)*2))>=" + BMIView.minBMI
                + " AND (weight/((height/100)*2))<=" + BMIView.maxBMI);
    }
