				...
				while (true) {
					...
					if (cOption == 1 || cOption == 2) {
						...
						if (cOption == 1) {
							...
							System.out.println("Number of books:" + bA.getQuantity() + " Price:" + bA.getPrice()
									+ " Tax:" + bA.getTax() + " Bill total for books:" + bA.getResult());
						}
						if (cOption == 2) {
							m = new MovieOrder();
							...
							System.out.println("Number of movies:" + mA.getQuantity() + " Price:" + mA.getPrice()
									+ " Tax:" + mA.getTax() + " Bill total for movies:" + mA.getResult());
						}
					} else if (cOption == 3) {
