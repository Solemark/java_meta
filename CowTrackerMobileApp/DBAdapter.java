...
public class DBAdapter {
    ...
    static final String DATABASE_CREATE = "create table cowTable (_id integer primary key autoincrement, " + "cow integer not null, condition text not null, weight text not null, age text not null, day integer not null, month integer not null, year integer not null, hour integer not null, minute integer not null, second integer not null);";
    ...
    public long insertCows(int cow, String condition, String weight, String age, int day, int month, int year, int hour, int minute, int second){
    ...
    public Cursor getAllCows(){
        return db.query(DATABASE_TABLE, new String[] {KEY_ROWID, KEY_COW, KEY_CONDITION, KEY_WEIGHT, KEY_AGE, KEY_DAY, KEY_MONTH, KEY_YEAR, KEY_HOUR, KEY_MINUTE, KEY_SECOND}, null, null, null, null, null);
    }

    public Cursor getCow(long rowId) throws SQLException{
        Cursor mCursor = db.query(true, DATABASE_TABLE, new String[] {KEY_ROWID, KEY_COW, KEY_CONDITION, KEY_WEIGHT, KEY_AGE, KEY_DAY, KEY_MONTH, KEY_YEAR, KEY_HOUR, KEY_MINUTE, KEY_SECOND}, KEY_ROWID + " = " + rowId, null, null, null, null, null);
        if(mCursor != null){
            mCursor.moveToFirst();
        }
        return mCursor;
    ...
    public boolean updateCow(long rowId, int cow, String weight, String age, String condition, int day, int month, int year, int hour, int minute, int second){
